...
public class PCGrid extends Grid{
    ...
    void setPCBoard(){
        ...
        Ship s1 = new Ship(2, this.gameBoard);
        this.addShip(s1, false);
        this.ships.add(s1);

        Ship s2 = new Ship(2, this.gameBoard);
        this.addShip(s2, false);
        this.ships.add(s2);

        Ship s3 = new Ship(3, this.gameBoard);
        this.addShip(s3, false);
        this.ships.add(s3);

        Ship s4 = new Ship(3, this.gameBoard);
        this.addShip(s4, false);
        this.ships.add(s4);

        Ship s5 = new Ship(3, this.gameBoard);
        this.addShip(s5, false);
        this.ships.add(s5);

        Ship s6 = new Ship(3, this.gameBoard);
        this.addShip(s6, false);
        this.ships.add(s6);

        Ship s7 = new Ship(4, this.gameBoard);
        this.addShip(s7, false);
        this.ships.add(s7);

        Ship s8 = new Ship(4, this.gameBoard);
        this.addShip(s8, false);
        this.ships.add(s8);

        Ship s9 = new Ship(5, this.gameBoard);
        this.addShip(s9, false);
        this.ships.add(s9);
        
        Ship s10 = new Ship(5, this.gameBoard);
